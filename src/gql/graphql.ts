...
export type CardAddProductMutationVariables = Exact<{
...
export type CardAddProductMutation = { createOrderItem?: { id: string } | null };

export type CartCreateMutationVariables = Exact<{ [key: string]: never; }>;


export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, images: Array<{ url: string }> } | null }> } | null };

export type CardDeleteProductMutationVariables = Exact<{
  itemId: Scalars['ID']['input'];
}>;


export type CardDeleteProductMutation = { deleteOrderItem?: { id: string } | null };
...
export type ProductsGetQuantityByCategorySlugQueryVariables = Exact<{
  where?: InputMaybe<ProductWhereInput>;
}>;


export type ProductsGetQuantityByCategorySlugQuery = { productsConnection: { aggregate: { count: number } } };
...
export const CardAddProductDocument = new TypedDocumentString(`
  ...
  createOrderItem(
    ...
    `) as unknown as TypedDocumentString<CardAddProductMutation, CardAddProductMutationVariables>;
...
export const CardDeleteProductDocument = new TypedDocumentString(`
    mutation CardDeleteProduct($itemId: ID!) {
  deleteOrderItem(where: {id: $itemId}) {
    id
  }
}
    `) as unknown as TypedDocumentString<CardDeleteProductMutation, CardDeleteProductMutationVariables>;
...
export const ProductsGetQuantityByCategorySlugDocument = new TypedDocumentString(`
  ...
  productsConnection(where: $where) {
    ...
    `) as unknown as TypedDocumentString<ProductsGetQuantityByCategorySlugQuery, ProductsGetQuantityByCategorySlugQueryVariables>;